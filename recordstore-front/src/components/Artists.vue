<template>
  <div class="max-w-md m-auto py-10">
    ...
    <h3  class="font-mono font-regular text-3xl mb-4">Addd a new artist</h3>
    ...
    <ul clas="list-reset mt-4">
      <li class-"py-4" v-for="artist in artists" :key="artist.id" :artist="artist">
        ...
        <div clsss="flex items-center justify-between flex-wrap">
          <p class="block flex-1 font-mon fone-semibold flex items-center ">
